...
const Hero = () => {
  return (
    <section id="home" className="bg-hero-pattern inset-0 bg-cover bg-center bg-fixed relative h-screen w-full  mx-auto max-w-7xl overflow-hidden">
      <div className="relative flex min-h-screen flex-row"><div className="absolute bottom-0 right-0 top-0 h-full w-2/12 bg-purple-700 lg:w-1/6 " data-aos="slide-left" data-aos-delay="1200">
